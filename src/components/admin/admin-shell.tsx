    ...
    <>
      <main className="mx-auto w-full max-w-[1440px] px-4 py-4 md:px-8 md:py-8">
        <div className="grid gap-6 lg:grid-cols-[250px_minmax(0,1fr)]">
          <aside className="flex flex-col rounded-2xl bg-[#111827] p-4 text-white shadow-[0_16px_40px_rgba(15,23,42,0.16)] md:p-5 lg:min-h-[calc(100vh-7rem)]">
            ...
            <div className="pt-6 lg:mt-auto">
              <button
                ...
                className="inline-flex min-h-11 w-full items-center justify-center rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-[14px] font-medium text-white transition-colors hover:bg-white/10"
              >
                Logout
              </button>
            </div>
          ...
          <div className="w-full max-w-[380px] rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_20px_60px_rgba(15,23,42,0.2)] sm:p-6">
            ...
            <div className="mt-6 grid gap-3 sm:flex sm:flex-wrap">
              <button
                ...
                className="inline-flex min-h-11 w-full items-center justify-center rounded-lg bg-slate-900 px-5 py-3 text-[13px] font-medium text-white transition-colors hover:bg-slate-800 sm:w-auto"
              >
                Cancel
              </button>
              <button
                type="button"
                onClick={() => router.push("/")}
                className="inline-flex min-h-11 w-full items-center justify-center rounded-lg border border-rose-200 bg-rose-50 px-5 py-3 text-[13px] font-medium text-rose-600 transition-colors hover:bg-rose-100 sm:w-auto"
              >
                Confirm Logout
              </button>
            </div>
